...
BOXED_GAME.actors = (function(game) {
  ...
  function Shot() {
    ...
    me.draw = function() {
      ...
      ctx.fillRect(translated.getX(), translated.getY(), me.dimension.width, me.dimension.height);
      ctx.fillStyle = old;
    };

    me.update = function() {
      //console.log("hey");
      //me.position.setY( me.position.getY() +  );

      me.position.addme( new Vector(me.shooter.velocity.getX(), me.velocity * game.variables.dt) );
    };
